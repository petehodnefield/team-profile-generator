    ...
    Application.prototype.getTeamInfo = function() {
        ...
        .then(personData => {
            ...
            // If they don't want more people,
                ...
                // Run the data from temp storage into the HTML generation function
                // Then, push the HTML info into employeeStorage
                employeeStorage.push(engintHTML(tempStorage))
